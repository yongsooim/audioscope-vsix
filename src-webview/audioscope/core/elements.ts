...
export function createAudioscopeElements() {
  return {
    ...
    loudnessLegend: requireElement<HTMLElement>('spectrogram-loudness-legend'),
    loudnessLegendMomentary: requireElement<HTMLElement>('spectrogram-loudness-legend-momentary'),
    loudnessLegendShortTerm: requireElement<HTMLElement>('spectrogram-loudness-legend-shortterm'),
    loudnessLegendPeak: requireElement<HTMLElement>('spectrogram-loudness-legend-peak'),
    loudnessLegendPeakText: requireElement<HTMLElement>('spectrogram-loudness-legend-peak-text'),
    loudnessLegendIntegratedText: requireElement<HTMLElement>('spectrogram-loudness-legend-integrated-text'),
